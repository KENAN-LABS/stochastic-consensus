...
This grader asserts the committed total. It is also where this case records why
it carries no `llm` grader at all.
...
free grader wherever that is true. So the rubric became the seven regexes in this
directory, which together with the two `tool_used` graders make the case's 9/9.
They cost nothing, they cannot return a 2-1 split, and they cannot fail correct
output — which a judge did, four times, at real expense.
